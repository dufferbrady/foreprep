...
function ProductModal({ isOpen, onClose, onSuccess, onError, product }: ProductModalProps) {
  ...
  const fetchOptions = async () => {
    ...
    try {
      ...
      onError('Failed to load categories and departments')
    } finally {
            ...
            {loadingOptions ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  {categories.length === 0 && (
                    <p className="mt-1 text-xs text-amber-600">No categories available. Add them in Settings.</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {departments.length === 0 && (
                    <p className="mt-1 text-xs text-amber-600">No departments available. Add them in Settings.</p>
                  )}
                </div>
